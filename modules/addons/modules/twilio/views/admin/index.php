...
/* @var $searchModel app\modules\addons\modules\twilio\models\TwilioSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Twilio SMS');
...
if (Yii::$app->user->can('configureAddons')) {
    $settingsLink = Html::a(Yii::t('app', 'Global Settings'), ['/addons/twilio/admin/settings'], [
        'data-toggle' => 'tooltip',
        'data-placement'=> 'top',
        'title' => Yii::t('app', 'Enter the Twilio account information that will be used for all the SMS notifications.'),
        'class' => 'text'
    ]);
}
            ...
            <div class="col-md-12">
                <?= GridView::widget([
                    ...
                    'panel' => [
                        ...
                        'heading'=> Yii::t('app', 'Twilio SMS')
                            . ' <small class="panel-subtitle hidden-xs">'
                            . Yii::t('app', 'Send SMS notifications or Phone verifications in real time')
                            . '</small>',
